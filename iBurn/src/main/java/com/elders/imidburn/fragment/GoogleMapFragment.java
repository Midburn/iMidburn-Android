...
import com.elders.imidburn.BuildConfig;
...
import com.elders.imidburn.activity.MainActivity;
import com.elders.imidburn.activity.PlayaItemViewActivity;
...
import com.elders.imidburn.database.UserPoiTable;
import com.elders.imidburn.js.JSEvaluator;
import com.elders.imidburn.location.LocationProvider;
import com.elders.imidburn.view.Utils;
...
/*    public static final double MAX_LAT = 32.072129;
    public static final double MAX_LON = 34.768235;
    public static final double MIN_LAT = 32.068720;
    public static final double MIN_LON = 34.773100;*/
...
//                .doOnNext(evaluator -> Timber.d("Got evaluator"))
                .flatMap(time -> LocationProvider.observeCurrentLocation(getActivity().getApplicationContext(),
                        ...
                        .doOnNext(location -> {
                            ...
                            if (distance[0] > 1500) {
                                ...
                                addressLabel.setText("Outside Midburn Playa");
...
//                    Timber.d("Zoom: " + cameraPosition.zoom);
     ...
     * adding to Map
     * <p>
     * Note: drawableResId is an int constant from {@link com.elders.imidburn.database.UserPoiTable}
     */
